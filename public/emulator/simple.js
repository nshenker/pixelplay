...
// User configurable.
const ROM_FILENAME = "dayatlake.gb";
...
// Load a ROM.
window.go = async () => {
  console.log("here is the rom", window.rom);
  let response = await fetch(window.rom);
...
class Emulator {
  ...
  bindKeys() {
    this.keyFuncs = {
      ...
      KeyB: this.setJoypB.bind(this),
      KeyA: this.setJoypA.bind(this),
